...
$secureScoreDumpFile = "F:\HealthChecks\$CustomerID\M365\Audit\$localsecurescorefile"
...
$MBX = Get-CsTenantFederationConfiguration

# Check if anonymous users are allowed to join meetings
$isAllowedA = $MBX.AllowTeamsConsumer -like "*False*"
$isAllowedB = $MBX.AllowPublicUsers -like "*False*"
$isAllowedC = $MBX.AllowFederatedUsers -like "*False*"
...
Write-Output "Creating local file"
	...
	$outputObj | ConvertTo-Json -Depth 100 | Out-File -FilePath "F:\HealthChecks\$CustomerID\M365\$localfile"
