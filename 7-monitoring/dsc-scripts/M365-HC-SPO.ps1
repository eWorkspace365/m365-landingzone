...
$BasePath = "F:\HealthChecks\$Customer\Microsoft 365"
...
$OutputCSV="F:\HealthChecks\$Customer\Microsoft 365\exchangeonline-sharingreport_$((Get-Date -format yyyy-MMM-dd-ddd` hh-mm` tt).ToString()).csv" 
