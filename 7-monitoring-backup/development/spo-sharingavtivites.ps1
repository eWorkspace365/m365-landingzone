...
##########################################################
Write-Host "=== Region: SharePoint sites (labels & sharing) ===" -ForegroundColor Cyan
...
Write-Host "JSON reports : 
  - sharepointonline-sensitivity-labels.json
  - sharepointonline-sites-labels.json
  - sharepointonline-sites-sharingactivity.json" -ForegroundColor Green
