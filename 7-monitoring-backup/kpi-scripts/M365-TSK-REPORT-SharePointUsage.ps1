...
$sites = Get-PnPTenantSite -IncludeOneDriveSites:$false | Where-Object {
    $_.LastContentModifiedDate -lt $DaysInactive -and $_.StorageUsageCurrent -ge 0
}
...
# Send the email
Write-Host "Sending email with the inactive sites report..." -ForegroundColor Yellow
